...
# ===================================================================
print("Entrenando Modelo Baseline: LightGBM (Características Originales)...")
lgb_baseline = LGBMClassifier(random_state=42, n_jobs=-1, verbose=-1)
lgb_baseline.fit(X_train, y_train)
print("Entrenamiento completado exitosamente.")

joblib.dump(lgb_baseline, os.path.join(BASE_DIR, 'src', 'ML_Simple','Resultados', 'encryption_classifier_lgb_baseline.pkl'))
# ===================================================================
...
# Cálculo de las 6 métricas reglamentarias (enfoque binario o macro según tu estructura)
...
print("\n" + "="*60)
print("   RENDIMIENTO BASELINE: LIGHTGBM DIRECTO (SIN CNN)")
print("="*60)
