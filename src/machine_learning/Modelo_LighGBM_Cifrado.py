...
# Silenciar advertencias visuales secundarias de nombres de columnas para un reporte impecable
...
lgb_encryption = LGBMClassifier(
    n_estimators=100,
    learning_rate=0.05,
    num_leaves=31,          # Parámetro leaf-wise crítico que auditaremos contra overfitting
    objective='binary',
    random_state=42,
    n_jobs=-1,
    verbose=-1
