...
joblib.dump(xgb_attack, os.path.join(BASE_DIR, 'src', 'Results', 'attack_classifier_xgb.pkl'))
...
plt.tight_layout()
ruta_grafico_ml = os.path.join(BASE_DIR, 'src', 'Results', 'diagnostic_overfitting_xgb_attack.png')
