...
le_attack = joblib.load(os.path.join(BASE_DIR, 'models', 'label_encoder_encryption.pkl'))
...
modelo_rf = joblib.load(os.path.join(BASE_DIR, 'src', 'Results', 'encryption_classifier_rf.pkl'))
